...
# Proyectos incluidos
- `mi_proyecto_sprint7` – Dashboard de anuncios de autos (Streamlit + Plotly). Enlace de la aplicación: https://mi-proyecto-sprint7-cu88.onrender.com
- Proyecto 2 – (pendiente)
- Proyecto 3 – (pendiente)

# Tecnologías
Python, Pandas, Plotly, Streamlit, Git, GitHub, VS Code.
